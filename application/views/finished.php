        ...
        <div class="">
            <div class="row align-items-center justify-content-between g-3 mb-6">
                <div class="col-12 col-md-auto">
                    <h2 class="mb-0">Finished Tickets</h2>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-sm fs--1 mb-0" style="width: 100vw;">
                        <thead>
                            <tr>
                                ...
                                <th class="sort border-top text-center" data-sort="status" style="min-width: 150px;">
                                    Status</th>
                                <th class="sort border-top text-center" data-sort="category" style="min-width: 200px;">
                                    Category</th>
                                <th class="sort border-top text-center" data-sort="completion date"
                                    style="min-width: 250px;">Completion Date</th>
                                <th class="sort border-top text-center" data-sort="notes" style="min-width: 500px;">
                                    Notes</th>
                                <th class="sort text-center align-middle pe-0 border-top" scope="col"
                                    style="min-width: 150px;">ACTION</th>
                            </tr>
                        </thead>
                        <tbody class="list" style="max-height: calc(100vh - 1000px); overflow-y: auto;">
                            <?php if ($query->num_rows() > 0) {
                                foreach ($result as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center white-space-nowrap text-end status">
                                        ...
                                        <td class="align-middle text-center completion_date">
                                            <?php echo $row["COMPLETED_DATE"]; ?>
                                        </td>
                                        <td class="align-middle note"><?php echo $row["NOTE"]; ?></td>
        ...
        <script>
            $(document).ready(function () {
                ...
                function filterTickets(dateRange) {
                    $.ajax({
                        url: '<?= base_url('index.php/UserController/filter_finished'); ?>',
                        type: 'POST',
