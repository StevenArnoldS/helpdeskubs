<?php
global $rand_id;
$sqlUser = 'SELECT * FROM M_USER WHERE ROLE = ?';
$queryUser = $this->db->query($sqlUser, array('Technician'));
        ...
        <div class="">
            <div class="row align-items-center justify-content-between g-3 mb-6">
                <div class="col-12 col-md-auto">
                    <h2 class="mb-0">Master Schedule</h2>
                </div>
            </div>

            <div id="tableExample3"
                data-list='{"valueNames":["id_schedule","date","technician_name"],"page":5,"pagination":true}'>
            ...
            <div class="col-auto" data-bs-toggle="modal" data-bs-target="#modalSchedule"><a
                    class="btn btn-primary px-5"><i class="fa-solid fa-plus me-2"></i>Add schedule</a>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editRoleModalLabel">Add Schedule</h5><button class="btn p-1"
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#scheduleDate').datepicker({
                    ...
                    todayHighlight: true,
                    orientation: "bottom",
                    container: '#modalSchedule',
                    templates: {
                        leftArrow: '<i class="fa fa-chevron-left"></i>',
                        rightArrow: '<i class="fa fa-chevron-right"></i>'
                    },
                    beforeShowDay: function (date) {
                        // Highlight weekends with custom CSS
                        let day = date.getDay();
                        return {
                            classes: (day === 0 || day === 6) ? 'weekend' : ''
                        };
                    }
                });
