...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Unfinished Tickets</title>
        ...
        <div class="">
            <div class="row align-items-center justify-content-between g-3 mb-6">
                <div class="col-12 col-md-auto">
                    <h2 class="mb-0">Unfinished Tickets</h2>
                </div>
            </div>

            <div id="tableExample3"
                data-list='{"valueNames":["id_ticket","problem","phone","ticket_date","technician","status","category","completion_date","note"],"page":10,"pagination":true}'>

                <div class="d-flex justify-content-between mb-3 align-items-center">
                    <!-- Date Range Picker -->
                    <div class="d-flex align-items-center">
                        <label class="form-label me-2 mb-0" for="timepicker2">Select Time Range</label>
                        ...
                        <thead>
                            <tr>
                                <th class="sort border-top text-center ps-3" data-sort="id" style="min-width: 125px;">Id
                                    Ticket</th>
                                <th class="sort border-top text-center" data-sort="problem" style="min-width: 500px;">
                                    Problem</th>
                                <th class="sort border-top text-center" data-sort="phone" style="min-width: 200px;">
                                    Phone</th>
                                <th class="sort border-top text-center" data-sort="ticket date"
                                    style="min-width: 250px;">Ticket Date</th>
                                <th class="sort border-top text-center" data-sort="category" style="min-width: 200px;">
                                    Category</th>
                            ...
                            <?php if ($query->num_rows() > 0) {
                                foreach ($result as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="align-middle problem"><?php echo $row["PROBLEM"]; ?></td>
                                            ...
                                            <div class="font-sans-serif btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    ...
                                                    if ($row["STATUS"] != 'on-progress') {
                                                        echo '
    <a class="dropdown-item accept-ticket" data-id="' . $row['ID_TICKET'] . '" href="#!">Accept Ticket</a>';
                                                    } else {
                                                        echo '
    <a class="dropdown-item note-btn" data-ticket-id="' . $row["ID_TICKET"] . '" data-bs-toggle="modal" data-bs-target="#note">Add Notes</a>
    ...
    <a class="dropdown-item text-success finish" id="btn-check">Finish Ticket</a>';
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="verticallyCenteredModalLabel">Add Note</h5><button class="btn p-1"
        ...
        <div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="verticallyCenteredModalLabel">Upload Attachment</h5><button
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.accept-ticket').on('click', function () {
                    var ticketId = $(this).data('id'); // Mengambil ID_TICKET dari tombol
                    var categoryId = $(this).closest('tr').find('.form-select').val(); // Mendapatkan value kategori dari select box

                    $.ajax({
                        url: '<?= base_url('index.php/UserController/update_status') ?>', // Endpoint controller yang sama
                        type: 'POST',
                        data: {
                            ticket_id: ticketId,
                ...
                $(document).on('click', '.add-attachment', function () {
                    var ticketId = $(this).data('id'); // Ambil ticket ID dari data-id pada tombol
                    $('#ticket_id').val(ticketId); // Set ticket_id di hidden field di modal
                });
                ...
                flatpickr("#timepicker2", {
                    mode: "range",
                    dateFormat: "d/M/Y",  // Mengubah format agar sesuai dengan format di database (DD/Mon/YYYY)
                    disableMobile: true,
                    onChange: function (selectedDates, dateStr, instance) {
                        if (selectedDates.length === 2) { // Pastikan range tanggal dipilih
                            filterTickets(dateStr);
                        }
                    }
                });

                // Fungsi untuk mengirimkan request menggunakan AJAX
                function filterTickets(dateRange) {
                    $.ajax({
                        url: '<?= base_url('index.php/UserController/filter_unfinished'); ?>',
                        type: 'POST',
