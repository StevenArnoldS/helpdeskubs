...
$sql = 'SELECT * FROM M_CATEGORY ORDER BY ID';
...
<body>
    ...
    <div class="content">
        <div class="">
            ...
            <div id="tableExample3" data-list='{"valueNames":["id_category","category"],"page":10,"pagination":true}'>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm fs--1 mb-0">
                        <thead>
                            <tr>
                                <th class="sort border-top text-center ps-3" data-sort="id" style="width: 300px">Id
                                    Category</th>
                                <th class="sort border-top text-center" data-sort="problem">
                                    Category</th>
                                <th class="sort text-center align-middle pe-0 border-top" scope="col">ACTION</th>
                            </tr>
                        </thead>
                        <tbody class="list" style="max-height: calc(100vh - 400px); overflow-y: auto;">
                            <?php if ($query->num_rows() > 0) {
                                foreach ($result as $row) { ?>
                                    <tr>
                                        <td class="align-middle text-center ps-3 id_ticket"><?php echo $row["ID"]; ?>
                                        </td>
                                        <td class="align-middle text-center problem"><?php echo $row["CATEGORY"]; ?></td>
        ...
        <div class="d-inline mb-3" data-bs-toggle="modal" data-bs-target="#addCategory"><a
                class="btn btn-primary px-5"><i class="fa-solid fa-plus me-2"></i>Add Category</a></div>
        <!-- Modal Category -->
        <div class="modal fade" id="addCategory" tabindex="-1" aria-labelledby="addCategoryLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="verticallyCenteredModalLabel">Add Category</h5><button
