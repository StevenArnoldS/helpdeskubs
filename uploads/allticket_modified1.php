    ...
    <div class="content">
        <div class="">
            ...
            <div id="tableExample3"
                data-list='{"valueNames":["id_ticket","problem","phone","ticket_date","technician","status","category","completion_date","note"],"page":5,"pagination":true}'>
                            ...
                            <?php if ($query->num_rows() > 0) {
                                foreach ($result as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center status"><?php echo $row["STATUS"]; ?></td>
...
<?php
// Misalkan $status adalah variabel yang menyimpan status dari database
if ($status == 'unfinished') {
    echo '<td class="align-middle white-space-nowrap text-end statuses">
